  		...
  		<tr>
    		<td>
				<table border="0" align="center" cellpadding="0" cellspacing="0" class="main-table">
					...
					<tr>
      					<td class="content">
      						<c:forEach items="${followerNameList }" var="follower">
      							<c:if test="${!follower.follow}">
      								<form action="Follow" method = "post">
      									<div class="hide">
      										<input type="text" name = "followId" value="${follower.id}" />
      									</div>
      									<a href="/Final/Visit?visitId=${follower.id}">${follower.firstName }&nbsp${follower.lastName }</a>
      								...
      								<form action="UnFollow" method = "post">
      									<div class="hide">
      										<input type="text" name = "unFollowId" value="${follower.id}" />
      									</div>
      									<a href="/Final/Visit?visitId=${follower.id}">${follower.firstName }&nbsp${follower.lastName }</a> 	
