      					...
      					<td class="content">
      						<div>
      							<form action="SearchUser" method="post" id ="Search">
      								<input type = "text" name = "search"  placeholder="Search new friend..." autocomplete="off"/>
      						...
      						<c:forEach items="${followNameList }" var="follow">
      							<form action="UnFollow" method = "post">
      								<div class="hide">
      									<input type="text" name = "unFollowId" value="${follow.id}" />
      								</div>
      								<a href="/Final/Visit?visitId=${follow.id}">${follow.firstName }&nbsp${follow.lastName }</a>
